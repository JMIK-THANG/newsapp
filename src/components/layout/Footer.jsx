      ...
      <div className="mx-auto max-w-[1380px]">
        <div className="grid gap-10 border-b border-[#cfd2d3] pb-10 lg:grid-cols-[1.1fr_.9fr] lg:items-end">
          ...
          <div className="lg:justify-self-end">
            ...
            <p className="mt-0 mb-3 max-w-[430px] text-[15px] leading-6 text-[#4f5359]">Get the day’s most important stories and updates delivered to your inbox.</p>
            ...
            <div className="mt-2 min-h-4 text-[13px]" aria-live="polite">
        ...
        <div className="grid gap-7 py-7 md:grid-cols-[1fr_auto] md:items-center">
          <nav className="flex flex-wrap gap-x-6 gap-y-3" aria-label="Footer navigation">
            <Link className="text-sm font-normal text-[#4f5359] transition hover:text-[#182536]" to="/">Home</Link>
            {navigationItems.map((item) => <Link className="text-sm font-normal text-[#4f5359] transition hover:text-[#182536]" key={item} to={`/${item.toLowerCase()}`}>{item}</Link>)}
          </nav>
          <div className="flex gap-5 text-sm font-normal text-[#4f5359]"><Link className="hover:text-[#182536]" to="/about">About</Link><Link className="hover:text-[#182536]" to="/contact">Contact</Link><Link className="hover:text-[#182536]" to="/privacy">Privacy</Link></div>
        </div>

        <div className="flex flex-col gap-3 border-t border-[#cfd2d3] pt-5 text-[13px] leading-5 text-[#686e73] sm:flex-row sm:items-center sm:justify-between">
