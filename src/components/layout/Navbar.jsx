...
export default function Navbar() {
  ...
  return <header className="relative z-40 bg-[#f7f5ef] px-3 pt-3 pb-5 md:px-6">
    <div className="mx-auto flex min-h-[72px] max-w-[1380px] items-center gap-3 rounded-[12px] border border-[#dcdde0] bg-white py-1.5 pr-2.5 pl-3.5 lg:gap-7">
      <Link className="flex shrink-0 items-center" to="/" aria-label="Chinlung Today home"><img className="h-[58px] w-auto object-contain sm:h-[64px]" src="/chinlung-today-logo.png" alt="Chinlung Today" /></Link>
      <DesktopNavigation />
