    ...
    <main className="bg-white px-3 py-10 md:px-6 md:py-14" aria-labelledby="contact-title">
      <div className="mx-auto max-w-[1180px]">
        ...
        <div className="grid gap-12 py-9 lg:grid-cols-[.7fr_1.3fr] lg:gap-16">
          ...
          <section className="bg-[#f4f2ed] p-5 sm:p-7" aria-labelledby="contact-form-title">
            ...
            <form className="grid gap-5" onSubmit={handleSubmit}>
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between"><p className="m-0 text-[11px] leading-4 text-[#5f6368]">Please do not send passwords, financial details, or other sensitive personal information.</p><button className="flex shrink-0 cursor-pointer items-center justify-center gap-2 bg-[#202938] px-5 py-3 text-sm font-semibold text-white transition hover:bg-[#39485a]" type="submit">Send message <Icon name="arrow" /></button></div>
            </form>
