    ...
    <main className="bg-[#fcfbf8] px-3 py-10 md:px-6 md:py-14">
      <article className="mx-auto max-w-[1100px]">
        ...
        <header className="grid gap-8 border-b-2 border-[#111318] pb-9 lg:grid-cols-[1.25fr_.75fr] lg:items-end">
          ...
          <div className="lg:border-l lg:border-[#dcdde0] lg:pl-7"><p className="home-story-summary m-0">{explainer.introduction}</p><p className="mt-5 mb-0 text-[11px] font-semibold text-[#5f6368] uppercase">{explainer.category} · {explainer.readTime}</p></div>
        </header>
