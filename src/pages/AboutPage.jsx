    ...
    <main className="bg-white px-3 py-10 md:px-6 md:py-14" aria-labelledby="about-title">
      <div className="mx-auto max-w-[1080px]">
        ...
        <section className="border-y border-[#182536] py-9 text-center" aria-labelledby="principle-title">
          ...
          <p className="article-reading-text mx-auto mb-0 max-w-2xl">This principle reflects our commitment to putting truth first and serving the public through responsible journalism.</p>
        </section>
